...
class ScoreFollower:
    ...
    def _proc(self, a_time, prev_a_time, a_data, a_input: audio_io.AbcAudioInput):
        if self._dump:
        ...
        pos_from_time = math.floor((a_time - a_input.start_time) / self._resolution)
        a_pitch = self._sax_pitch[pos_from_time]
        a_onset = self._sax_onset[pos_from_time]
